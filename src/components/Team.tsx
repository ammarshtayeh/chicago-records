      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {team.map((member, index) => (
            ...
            >
              <div className="p-6 rounded-2xl bg-gray-800/60 backdrop-blur-xl border border-pink-500/20 shadow-xl hover:shadow-pink-500/20 hover:border-pink-500/40 transition-all duration-300 overflow-hidden">
                {/* Background Gradient */}
                <div
                ...
                <motion.div
                  whileHover={{ rotate: 5 }}
                  className="relative w-24 h-24 mx-auto mb-5 rounded-full bg-gradient-to-br from-gray-700 to-gray-800 border-2 border-pink-500/30 group-hover:border-pink-500/60 shadow-lg transition-all duration-300 overflow-hidden flex items-center justify-center"
                >
                ...
                <div className="flex justify-center gap-3">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="w-8 h-8 rounded-full bg-gray-700 hover:bg-pink-500 text-gray-300 hover:text-white flex items-center justify-center transition-colors"
                  >
                  ...
                  <motion.button
                    whileHover={{ scale: 1.1 }}
                    whileTap={{ scale: 0.95 }}
                    className="w-8 h-8 rounded-full bg-gray-700 hover:bg-cyan-500 text-gray-300 hover:text-white flex items-center justify-center transition-colors"
                  >
